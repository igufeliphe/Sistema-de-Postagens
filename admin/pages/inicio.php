     ...
     <div class="row">
            ...
            <?php
               ...
               '<div class="alert alert-info">
                      ...
                      <strong>Olá, '.$nomeLogado.'!</strong> Seja Bem vindo ao <strong>iGU System</strong> !
               </div>';
					}
				}
			 ?>  
            ...
            <div class="span12">	      		
	      		<div id="target-1" class="widget">	      			
	      			<div class="widget-content">	      				
			      		<h1>iGU System - Apresentação</h1>			      		
			      		<hr>
                <p>O <strong>iGU System</strong> é um Sistema de Postagem desenvolvido para estudos, cujo objetivo é gerenciar toda parte de postagens e
                        algumas funções internas do próprio sistema.	<br>
                        O Sistema foi desenvolvido na linguagem <strong>PHP</strong>, utilizando juntamente com a classe <strong>PDO</strong>. O banco de dados utilizado é o <strong>MySQL</strong>.</p>
                        
                        
                        <p><strong>Igor Feliphe.</strong></p>
